...
-- CreateEnum
CREATE TYPE "CallStatus" AS ENUM ('NON_CONTACTE', 'CONTACTE', 'RESISTANT', 'CONFIRME', 'REFUS');
...
-- AddForeignKey
ALTER TABLE "export_logs" ADD CONSTRAINT "export_logs_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "recruitment_sessions"("id") ON DELETE SET NULL ON UPDATE CASCADE;
