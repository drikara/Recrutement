...
async function main() {
  ...
  await prisma.score.create({
    data: {
      ...
      presentationVisuelle: 2,
      phase1FfDecision: FFDecision.FAVORABLE,
      psychoRaisonnementLogique: 5,
      psychoAttentionConcentration: 5,
      ...
      excelTest: 3,
      dictation: 3,
      simulationSensNegociation: 5,
      simulationCapacitePersuasion: 5,
      simulationSensCombativite: 3,
      salesSimulation: 3,
      analysisExercise: 3,
